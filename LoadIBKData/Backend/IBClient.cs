...
using LoadIBKData.UI;

namespace LoadIBKData.Backend
{
    class IBClient : EWrapper
    {
        ...
        public event Action<Messages.SoftDollarTiersMessage> SoftDollarTiers;
        ...
        void EWrapper.softDollarTiers(int reqId, SoftDollarTier[] tiers)
        {
            ...
            if (tmp != null)
                sc.Post((t) => tmp(new Messages.SoftDollarTiersMessage(reqId, tiers)), null);
        }
